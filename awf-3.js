(function () {
          ...
          },
          {
            ...
            value: function () {
              ...
              this.view.next.addEventListener("click", function () {
                ...
                this.view.sendHiddenForm &&
                  this.view.rightArrow.addEventListener("click", function t() {
  ...
  var xa = (function () {
      ...
      return (
        wa(e, [
          ...
          },
          {
            key: "setStepsDisplay",
            value: function (e) {
              this.currentStepDisplay && (this.currentStepDisplay.textContent = (e + 1).toString()), this.completedPercentageDisplay && (this.completedPercentageDisplay.textContent = "".concat(Math.round((e / (this.steps.length - 1)) * 100), "%"));
            },
          },
          {
    ...
    ya = var xa = (function () {
      function e(t) {
        // Existing code for slide navigation and form submission
    
        // Add the provided code here
        // ...
    
        function updatePageNumbers() {
          // Code to update page numbers and order
          // ...
        }
  ...
  function bb(o, r, t) {
    ...
    return (
      (r = ka(r) || 0),
      _(t) && ((c = !!t.leading), (n = (f = "maxWait" in t) ? _a(ka(t.maxWait) || 0, r) : n), (y = "trailing" in t ? !!t.trailing : y)),
      (d.cancel = function () {
